...
const translations = {
    ru: {
        ...
        expenses_title: "💡 Как увеличить сумму возврата?",
        expenses_intro: "Вы можете вернуть больше налогов, если вы несли рабочие расходы за свой счет:",
        expenses_uniform: "👕 <b>Стирка униформы:</b> £60 в год, если вы стираете форму сами.",
        expenses_boots: "🥾 <b>Защитная одежда:</b> Рабочие ботинки, непромокаемая одежда.",
        expenses_tools: "✂️ <b>Инструменты:</b> Оборудование, необходимое для работы в поле.",
        expenses_action: "Укажите эти расходы при подаче декларации в HMRC, чтобы увеличить свой необлагаемый минимум.",
        tab_calc: "Калькулятор",
        tab_info: "Информация",
        scan_payslip: "📷 Скан Payslip",
        scanning_wait: "Распознавание...",
        scan_success: "Данные успешно извлечены!",
        scan_error: "Не удалось распознать текст. Попробуйте сделать фото четче или введите данные вручную.",
    },
    en: {
        ...
        expenses_title: "💡 How to increase your refund?",
        expenses_intro: "You can get more tax back if you had work-related expenses out of pocket:",
        expenses_uniform: "👕 <b>Uniform washing:</b> £60 per year if you wash work uniform yourself.",
        expenses_boots: "🥾 <b>Protective gear:</b> Safety boots, waterproof clothing.",
        expenses_tools: "✂️ <b>Tools:</b> Equipment required for work.",
        expenses_action: "Claim these expenses when submitting your HMRC declaration to increase your tax-free allowance.",
        tab_calc: "Calculator",
        tab_info: "Info",
        scan_payslip: "📷 Scan Payslip",
        scanning_wait: "Scanning...",
        scan_success: "Data extracted successfully!",
        scan_error: "Failed to recognize text. Please take a clearer photo or enter data manually.",
    },
    uz: {
        ...
        expenses_title: "💡 Qaytarma summasini qanday oshirish mumkin?",
        expenses_intro: "Agar siz o'z hisobingizdan ishingiz uchun xarajat qilgan bo'lsangiz, ko'proq soliq qaytarib olishingiz mumkin:",
        expenses_uniform: "👕 <b>Uniforma yuvish:</b> Agar formangizni o'zingiz yuvsangiz, yiliga £60.",
        expenses_boots: "🥾 <b>Himoya kiyimi:</b> Xavfsizlik poyabzali (botinka), suv o'tkazmaydigan kiyim.",
        expenses_tools: "✂️ <b>Asboblar:</b> Dala ishlari uchun kerakli uskunalar.",
        expenses_action: "Soliqsiz limitni oshirish uchun HMRC deklaratsiyasini topshirishda ushbu xarajatlarni ko'rsating.",
        tab_calc: "Kalkulyator",
        tab_info: "Ma'lumot",
        scan_payslip: "📷 Payslip Skaner",
        scanning_wait: "O'qilmoqda...",
        scan_success: "Ma'lumotlar muvaffaqiyatli aniqlandi!",
        scan_error: "Matnni aniqlab bo'lmadi. Rasm tiniqroq ekanligiga ishonch hosil qiling yoki qo'lda kiriting.",
    },
    kk: {
        ...
        expenses_title: "💡 Қайтару сомасын қалай көбейтуге болады?",
        expenses_intro: "Егер сіз жұмысқа өз қаражатыңызбен шығындалған болсаңыз, көбірек салық қайтара аласыз:",
        expenses_uniform: "👕 <b>Униформа жуу:</b> Егер формаңызды өзіңіз жусаңыз, жылына £60.",
        expenses_boots: "🥾 <b>Қорғаныс киімі:</b> Қауіпсіздік етіктері, су өткізбейтін киім.",
        expenses_tools: "✂️ <b>Құралдар:</b> Жұмысқа қажетті жабдықтар.",
        expenses_action: "Салық салынбайтын шекті арттыру үшін HMRC декларациясын тапсырған кезде осы шығындарды көрсетіңіз.",
        tab_calc: "Калькулятор",
        tab_info: "Ақпарат",
        scan_payslip: "📷 Payslip Сканер",
        scanning_wait: "Оқылуда...",
        scan_success: "Деректер сәтті шығарылды!",
        scan_error: "Мәтінді тану мүмкін болмады. Суреттің анықтығын тексеріңіз немесе қолмен енгізіңіз.",
    },
    ky: {
        ...
        expenses_title: "💡 Кайтаруу суммасын кантип көбөйтсө болот?",
        expenses_intro: "Эгерде сиз жумушчу чыгымдарыңызды өзүңүз төлөгөн болсоңуз, көбүрөөк салык кайтарып алсаңыз болот:",
        expenses_uniform: "👕 <b>Униформа жуу:</b> Формаңызды өзүңүз жуусаңыз, жылына £60.",
        expenses_boots: "🥾 <b>Коргоочу кийим:</b> Коопсуздук өтүгү, суу өткөрбөөчү кийим.",
        expenses_tools: "✂️ <b>Куралдар:</b> Жумушка керектүү жабдуулар.",
        expenses_action: "Салык алынбаган минимумду көбөйтүү үчүн HMRC декларациясын тапшырууда ушул чыгымдарды көрсөтүңүз.",
        tab_calc: "Калькулятор",
        tab_info: "Маалымат",
        scan_payslip: "📷 Payslip Сканер",
        scanning_wait: "Окулууда...",
        scan_success: "Маалыматтар ийгиликтүү чыгарылды!",
        scan_error: "Текстти таануу мүмкүн болгон жок. Сүрөттүн дааналыгын текшериңиз же кол менен киргизиңиз.",
        tab_auditor: "Аудит",
        auditor_title: "UK Payslip Auditor",
        auditor_desc: "Фермалардын жана агенттиктердин чынчылдыгын акылдуу текшерүү. Укуктарыңызды өз тилиңизде коргоо.",
        scan_payslip_audit: "Жүктөө жана текшерүү",
        audit_feature_1: "✅ Минималдуу эмгек акыны (NMW) текшерүү",
        audit_feature_2: "✅ Салык кодун (Tax Code) талдоо",
        audit_feature_3: "✅ Жашоо үчүн кармап калууларды текшерүү",
        audit_feature_4: "✅ Анонимдүү фермалар статистикасы (Коомчулук)"
    },
    tg: {
        ...
        expenses_title: "💡 Маблағи баргардониро чӣ гуна зиёд кардан мумкин аст?",
        expenses_intro: "Агар шумо барои кор аз ҳисоби худ хароҷот карда бошед, андози бештарро баргардонида метавонед:",
        expenses_uniform: "👕 <b>Шустани либоси корӣ:</b> Дар як сол £60, агар худатон шӯед.",
        expenses_boots: "🥾 <b>Либоси муҳофизатӣ:</b> Мӯзаҳои бехатарӣ, либоси обногузар.",
        expenses_tools: "✂️ <b>Асбобҳо:</b> Таҷҳизоте, ки барои кор лозим аст.",
        expenses_action: "Барои зиёд кардани ҳадди беандози худ дар вақти пешниҳоди декларатсия ба HMRC ин хароҷотҳоро нишон диҳед.",
        tab_calc: "Калькулятор",
        tab_info: "Маълумот",
        scan_payslip: "📷 Скан Payslip",
        scanning_wait: "Хонда истодааст...",
        scan_success: "Маълумот бомуваффақият гирифта шуд!",
        scan_error: "Шинохтани матн ғайриимкон аст. Илтимос, акси равшантар гиред ё ба таври дастӣ ворид кунед.",
    }
};
