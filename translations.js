...
const translations = {
    ...
    uz: {
        ...
        select_months: "Oylar sonini tanlang",
        month_1: "1 oy",
        month_2: "2 oy",
        month_3: "3 oy",
        month_4: "4 oy",
        ...
        income_period: "Davr uchun Umumiy Daromad (£):",
        income_placeholder: "Ish davri uchun umumiy daromadingizni kiriting",
        tax_withheld: "Ushlab Qolingan Soliq (£):",
        ...
        refund_title: "🎉 Sizning HMRC Qaytarishingiz",
...
function changeLanguage(lang) {
    ...
    if (currentLanguageElement) {
        currentLanguageElement.textContent = getLanguageDisplay(lang);
    }
...
function initLanguage() {
    ...
    // Обработчик для кнопки выбора языка в хедере
    if (languageButton) {
